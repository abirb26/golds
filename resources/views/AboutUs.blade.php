...
<nav class="navbar navbar-expand-lg bg-secondary border-warning sticky-top mb-3">
    <div class="container-fluid">
        <a class="navbar-brand my-auto" href="Welcome.html"><img class="rounded-circle"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav justify-content-start flex-grow-1">
                <li class="nav-item active">
                    <a class="nav-link btn btn-outline-warning mr-sm-2 mb-2 " href="Home.html" id="home">Home <span
                            class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle btn btn-outline-warning mr-sm-2 mb-2 " href="Product.html" role="button" data-toggle="dropdown" aria-expanded="false">
                      Product
                    </a>
                    <div class="dropdown-menu" style="background-color:rgba(249, 242, 242, 0.256)">
                        <a class="dropdown-item text-warning" href="Product.html">Necklace</a>
    ...
    <h3 class="h3 ml-4 mt-4 font-weight-normal font-italic" id="aboutus">About Us</h3>
    <hr class="ml-4 w-50">


    <div class="ml-4">
        <p class="h5"><b>Our Vision</b></p>
        <p id="demo">"We will lead our industry by defining service excellence and building unmatched customer loyalty." </p>
        <p class="h5"><b>Our Mission</b></p>
        <p>"We will ensure a stress-free car rental experience by providing superior services that cater to our
            customers." </p>
        <p class="h5"><b>Quality</b></p>
        <ul>
            <li>We will place the interests of our customers first.</li>
            <li>We will be dedicated to providing an individualized rental experience that assures customer satisfaction
                and earns the unwavering loyalty of our customers.</li>
        </ul>
        <p class="h5"><b>Teamwork</b></p>
        <ul>
            <li>We will work as one cohesive team from the smallest unit to the organization as a whole.</li>
            <li>We will develop and retain leaders who continually raise the bar, provide direction,
                remove barriers and empower people to successfully accomplish goals.</li>
            <li>We will maintain a caring and supportive work environment that fosters a sharing of ideas, skills and
                resources.</li>
        </ul>

        <a class="btn btn-warning m-4" href="Home.html" id="back">Shop Now</a>
    ...
    <div class="w-100 text-center font-weight-bold sticky-bottom" style="font-size: 10px; bottom: 0; position: fixed;"> Copyright 2024 by AMR
        ALSEBAI </div>
